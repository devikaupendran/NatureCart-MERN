...
export const ProductCard = ({ product }) => {
    ...
    const { currencySymbol, cartItems, addToCart, removeCartItem, navigate } = useAppContext()
                ...
                <div className="text-gray-500/60 text-sm">
                    ...
                    <div className="flex items-end justify-between mt-3">
                        ...
                        <div className="text-green-700" onClick={(e) => { e.stopPropagation() }}>
                            {
                                //if the product id is not already available in the cart then show add button otherwise show + and -
                                !cartItems[product._id] ? (
                                    <button className="flex items-center justify-center gap-1 bg-green-100 border border-green-300 md:w-[80px] w-[64px] h-[34px] rounded text-green-700 font-medium cursor-pointer"
